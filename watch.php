<?php
	...
	$query1 = "select w.img,p.model,p.price,w.feature from watch AS w inner join product AS p on w.pid=p.PID";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="watch.php" style="color: gray;">Watch</a>
                    </li>
                    <li class="nav-item">
