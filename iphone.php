<?php
	...
	$query1 = "select i.img,p.model,p.price,i.display,i.network,i.camera,i.chip,i.biometrics,i.capacity,i.color from iphone AS i inner join product AS p on i.pid=p.PID";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="iphone.php" style="color: gray;">iPhone</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <!-- <li class="nav-item">
                        <i class="far fa-shopping-bag"><a class="nav-link" href="cart.html">.</a></i>
                    </li> -->
                </ul>
            </div>
        </div>
