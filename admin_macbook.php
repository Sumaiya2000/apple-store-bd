    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link"  href="admin_macbook.php" style="color: gray">MacBook</a>
                </li>
                <li class="nav-item">
    ...
    <div class="small-container">
        <div class="row">
            ...
            <div style="padding-top: 20px" class="col-3">
				...
				<p>Product ID: <?php echo $result[13];?></p>
                <p class="desc">
					...
					if (isset($_POST['delete'])){
						$pid=$_POST['pid'];
						$del="DELETE FROM `macbook` WHERE pid='$pid'";
            ...
            <br>
        <center>
            <a href="macbook_insert.php" style="color: rgb(100, 100, 100); font-size: 30px;"><b>ADD PRODUCT</b></a>
        </center>
    </div>
</div>
