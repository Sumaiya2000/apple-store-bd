...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="admin_watch.php" style="color: gray;">Watch</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="categories">
        ...
        <div class="small-container">
			...
			<?php
                ...
                <div class="col-12">
					...
					if (isset($_POST['delete'])){
						$pid=$_POST['pid'];
						$del="DELETE FROM `watch` WHERE pid='$pid'";
            ...
            <br>
            <center>
                <a href="watch_insert.php" style="color: rgb(100, 100, 100); font-size: 30px;"><b>ADD PRODUCT</b></a>
            </center>
        </div>
    </div>
