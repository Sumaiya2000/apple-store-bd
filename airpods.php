<?php
	...
	$query1 = "select ap.img,p.model,p.price,ap.feature,ap.chip,ap.casetype from airpods AS ap inner join product AS p on ap.pid=p.PID";
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link"  href="airpods.php" style="color: gray">AirPods</a>
                </li>
                <li class="nav-item">
