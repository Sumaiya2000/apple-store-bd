        ...
        <div class="small-container">
			...
			<?php
                ...
                <div class="col-12">
					...
					<p>Product ID: <?php echo $result[3];?></p>
					<?php
					if (isset($_POST['delete'])){
						$pid=$_POST['pid'];
						$del="DELETE FROM `accessories` WHERE pid='$pid'";
            ...
            <br>
            <center>
                <a href="accessories_insert.php" style="color: rgb(100, 100, 100); font-size: 30px;"><b>ADD PRODUCT</b></a>
            </center>
        </div>
    </div>
