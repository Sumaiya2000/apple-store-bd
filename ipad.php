<?php
	...
	$query1 = "select ip.img,p.model,p.price,ip.display,ip.chip,ip.camera,ip.speaker,ip.biometrics,ip.capacity,ip.color from ipad AS ip inner join product AS p on ip.pid=p.PID";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="ipad.php" style="color: gray;">iPad</a>
                    </li>
                    <li class="nav-item">
